...
const STRINGS = {
  ...
  'product.like': { en: 'Save to wishlist', hi: 'विशलिस्ट में सहेजें', te: 'విష్‌లిస్ట్‌కి సేవ్ చేయండి' },
  'product.unlike': { en: 'Remove from wishlist', hi: 'विशलिस्ट से हटाएँ', te: 'విష్‌లిస్ట్ నుండి తొలగించండి' },
  ...
  'login.signInSub': {
    en: 'Confirm your number. No password.',
    hi: 'अपना नंबर पक्का करें। कोई पासवर्ड नहीं।',
    te: 'మీ నంబర్‌ను నిర్ధారించండి. పాస్‌వర్డ్ లేదు.',
  },
  'login.sendUsCode': { en: 'Send us this code', hi: 'हमें यह कोड भेजें', te: 'ఈ కోడ్‌ను మాకు పంపండి' },
  'login.sendUsCodeSub': {
    en: 'Open WhatsApp, hit send, and you’re in.',
    hi: 'WhatsApp खोलें, भेजें दबाएँ, और आप अंदर हैं।',
    te: 'WhatsApp తెరిచి పంపండి నొక్కండి — మీరు లోపలికి వచ్చేస్తారు.',
  },
  'login.sendUsCodeSubRegister': {
    en: 'Open WhatsApp, hit send, and we’ll create your account.',
    hi: 'WhatsApp खोलें, भेजें दबाएँ, और हम आपका खाता बना देंगे।',
  ...
  */
  ...
  'login.shopkeeperCodesSub': {
    en: 'Confirm your number. You’ll verify your bank account next.',
    hi: 'अपना नंबर पक्का करें। अगला क़दम आपके बैंक खाते की पुष्टि है।',
    te: 'మీ నంబర్‌ను నిర్ధారించండి. తర్వాత మీ బ్యాంక్ ఖాతాను ధృవీకరిస్తారు.',
  },
  ...
  'login.deliveryCodesSub': {
    en: 'Confirm your number, and you can go on duty straight away.',
    hi: 'अपना नंबर पक्का करें, और आप तुरंत ड्यूटी पर जा सकते हैं।',
    te: 'మీ నంబర్‌ను నిర్ధారించండి, వెంటనే డ్యూటీలో చేరవచ్చు.',
  },
  'login.identifier': { en: 'Mobile number', hi: 'मोबाइल नंबर', te: 'మొబైల్ నంబర్' },
  'login.rememberMe': {
  ...
  'login.twoWays': {
    en: 'We’ll prove this number is yours. That’s the whole of signing up.',
  ...
  'login.sendMyCodes': { en: 'Continue', hi: 'आगे बढ़ें', te: 'కొనసాగండి' },
  'login.startOver': { en: 'Start over', hi: 'फिर से शुरू करें', te: 'మళ్లీ మొదలుపెట్టండి' },
  'login.whatsappDown': {
    en: 'WhatsApp could not reach this number. Send us a message instead, or try again in a moment.',
    hi: 'WhatsApp इस नंबर तक नहीं पहुँच सका। इसके बजाय हमें एक संदेश भेजें, या थोड़ी देर बाद कोशिश करें।',
    te: 'WhatsApp ఈ నంబర్‌ను చేరలేకపోయింది. బదులుగా మాకు సందేశం పంపండి, లేదా కాసేపు తర్వాత ప్రయత్నించండి.',
  },
  ...
  'login.reverseVerified': {
    en: 'Number confirmed. Creating your account…',
    hi: 'नंबर पक्का हो गया। आपका खाता बन रहा है…',
    te: 'నంబర్ నిర్ధారించబడింది. మీ ఖాతా సృష్టిస్తున్నాం…',
  },
  ...
  'account.savedAddressNote': {
    ...
    te: 'ఆర్డర్లు డెలివరీ చేసేది, మీకు దగ్గరలోని మార్కెట్లు, దుకాణాలు కనుక్కునేది — ఈ చిరునామా ఆధారంగానే.',
  },
  'account.changeAddress': { en: 'Change Address', hi: 'पता बदलें', te: 'చిరునామా మార్చండి' },
  'account.removeAddress': { en: 'Remove Address', hi: 'पता हटाएँ', te: 'చిరునామా తొలగించండి' },
  'account.wishlist': { en: 'My Wishlist', hi: 'मेरी विशलिस्ट', te: 'నా విష్‌లిస్ట్' },
  'account.wishlistSub': {
    en: 'Products you have saved for later',
    hi: 'आपके सहेजे हुए प्रॉडक्ट',
    te: 'మీరు సేవ్ చేసిన ఉత్పత్తులు',
  },
  'account.wishlistEmpty': { en: 'Your wishlist is empty', hi: 'आपकी विशलिस्ट खाली है', te: 'మీ విష్‌లిస్ట్ ఖాళీగా ఉంది' },
  'account.wishlistEmptySub': {
    en: 'Tap the heart on any product to save it here.',
    hi: 'किसी भी प्रॉडक्ट पर दिल के निशान को दबाकर उसे यहाँ सहेजें।',
    te: 'ఏదైనా ఉత్పత్తిపై హార్ట్ నొక్కి దాన్ని ఇక్కడ సేవ్ చేయండి.',
  },
  'account.removeFromWishlist': { en: 'Remove from wishlist', hi: 'विशलिस्ट से हटाएँ', te: 'విష్‌లిస్ట్ నుండి తొలగించండి' },

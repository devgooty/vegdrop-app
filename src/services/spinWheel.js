 ...
 *
 * There is deliberately no `color` here any more. Each segment used to carry
 * one, and the wheel was read as a colour wheel with objects stuck on it: five
 * saturated wedges are far louder than four small photographs, so the fill was
 * doing the work the prize should. The face is now a single cream, divided by a
 * hairline, and the only colour on the whole object is the gold bezel around
 * it. Don't reintroduce a per-segment fill — if a segment needs distinguishing,
 * it needs a clearer prize, not a louder background.
 */
/**
...
export const PRIZES = [
  { id: 'egg-basket', label: 'Egg Basket', short: 'Egg Basket', labelKey: 'spin.prize.eggBasket', shortKey: 'spin.prize.short.eggBasket', emoji: '🧺', image: prizePhoto('egg-basket'), weight: 8 },
  { id: 'knife', label: 'Kitchen Knife', short: 'Knife', labelKey: 'spin.prize.knife', shortKey: 'spin.prize.short.knife', emoji: '🔪', image: prizePhoto('knife'), weight: 8 },
  { id: 'juice-glass', label: 'Juice Glass', short: 'Juice Glass', labelKey: 'spin.prize.juiceGlass', shortKey: 'spin.prize.short.juiceGlass', emoji: '🥤', image: prizePhoto('juice-glass'), weight: 10 },
  { id: 'slicer', label: '2-in-1 Vegetable Slicer', short: 'Slicer', labelKey: 'spin.prize.slicer', shortKey: 'spin.prize.short.slicer', emoji: '🔧', image: prizePhoto('slicer'), weight: 4 },
  /**
   ...
   */
  { id: 'none', label: 'Better Luck Next Time', short: 'Try Again', labelKey: 'spin.prize.none', shortKey: 'spin.prize.short.none', emoji: '🍀', image: null, weight: 70 },
];
